...
const ProjectSelector = ({ setSelectedProject, selectedProject, setCoordinates, showLocation, setLocateTypes, setLineNames }) => {
    ...
    const [locateType, setLocateType] = useState('');
    const rowsPerPage = 5;
    ...
    const handleLineNameChange = (event) => {
        setLineNames(event.target.value);
    };

    const handleLocateTypeChange = (event) => {
        setLocateTypes(event.target.value);
    };
    ...
    return (
        ...
        >
            <div style={{ width: `${width}px` }} className="">
                <div className="flex flex-col justify-start items-start h-screen overflow-y-auto w-full">
                            ...
                            <div>
                                <div className="bg-white shadow-md rounded-lg p-4 sm:p-6 w-full max-w-2xl mx-auto">
                                    ...
                                    <div className="flex flex-col space-y-4 mb-4 sm:mb-6">
                                        <label className="block text-lg font-medium text-gray-700">Line Name:</label>
                                        <input
                                            type="text"
                                            placeholder="Line Name"
                                            onChange={handleLineNameChange}  // Update LineNames on change
                                            className="w-full p-2 sm:p-3 border border-gray-300 rounded focus:outline-none focus:border-blue-500"
                                        />
                                        <label className="block text-lg font-medium text-gray-700">Locate Type:</label>
                                        <select
                                            id="downloadOption"
                                            onChange={handleLocateTypeChange}  // Update LocateTypes on change
            ...
            <div
                className="w-1 bg-gray-700 hover:bg-gray-300 duration-300 cursor-col-resize"
